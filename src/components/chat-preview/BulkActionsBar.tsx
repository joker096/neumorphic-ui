...
export const BulkActionsBar = ({ isDark, selectedIds, t, onCancel, onArchive, onDelete, onMarkRead }: BulkActionsBarProps) => (
  <div className={`flex items-center gap-1.5 sm:gap-2 mb-3 sm:mb-4 px-1 py-2 rounded-2xl shrink-0 ${isDark ? "bg-white/5" : "bg-black/5"}`}>
    <button onClick={onCancel} className={`px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-[10px] sm:text-xs font-bold transition-colors ${isDark ? "bg-[var(--bg-tertiary)] text-gray-300 hover:text-[var(--text-primary)] border border-[var(--border-color)]" : "bg-white text-slate-600 hover:text-slate-800 border border-[var(--border-color)] shadow-sm"}`}>
      {t("chat.cancel")}
    </button>
    ...
    <button onClick={onArchive} className={`px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-[10px] sm:text-xs font-bold transition-colors ${isDark ? "bg-[var(--bg-tertiary)] text-gray-300 hover:text-[var(--text-primary)] border border-[var(--border-color)]" : "bg-white text-slate-600 hover:text-slate-800 border border-[var(--border-color)] shadow-sm"}`}>
      {t("chat.archive")}
    </button>
    ...
    <button onClick={onMarkRead} className={`px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-[10px] sm:text-xs font-bold transition-colors ${isDark ? "bg-[var(--bg-tertiary)] text-gray-300 hover:text-[var(--text-primary)] border border-[var(--border-color)]" : "bg-white text-slate-600 hover:text-slate-800 border border-[var(--border-color)] shadow-sm"}`}>
      {t("chat.markRead")}
    </button>
  </div>
);
