  ...
  return (
    <div className="p-4 space-y-4">
      <div className="rounded-2xl border border-white/10 bg-[#1a1d24] p-4">
        ...
        <p className="text-sm text-gray-400 mt-1">{t('admin.description')}</p>
      </div>
      <div className="rounded-2xl border border-white/10 bg-[#1a1d24] p-4 space-y-3">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-sm font-semibold text-white">{t('admin.shareRecording')}</div>
            <div className="text-xs text-gray-400 mt-1">{t('admin.globalControl')}</div>
          </div>
          <button
