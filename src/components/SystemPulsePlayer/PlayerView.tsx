...
export const PlayerView = ({
  isDark, isRadioMode, isPlaying, setIsPlaying, setIsRadioMode, volume, setVolume,
  activeList, activeIndex, currentTrack, nextTrack, prevTrack, createRipple, initWebAudio,
  textColor, darkShadow, insetShadow
}: PlayerViewProps) => {
  return (
    <motion.div
      key="player-view"
    ...
    >
      <div     className={`w-[220px] h-[50px] flex items-center justify-center relative z-10 mb-6 ${isDark ? "bg-[#333a41]" : "bg-[#d1d8e0]"} ${insetShadow} transition-colors`}>
