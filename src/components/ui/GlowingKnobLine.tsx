...
export const GlowingKnobLine: React.FC<GlowingKnobLineProps> = ({ count }) => (
  <div className="w-[20px] h-[20px] rounded-full bg-[var(--bg-secondary)] shadow-[0_0_15px_rgba(255,160,80,0.8),_-2px_-2px_5px_rgba(255,255,255,0.9),_2px_2px_5px_rgba(165,175,190,0.5),_inset_1px_1px_2px_rgba(255,255,255,0.8)] shrink-0 flex items-center justify-center relative">
