...
export const SettingsSection = ({ title, onBack, children, icon: Icon }: SettingsSectionProps) => (
  ...
  >
    <div className="w-full max-w-full md:max-w-[640px] flex flex-col">
      <div className="flex items-center gap-3 shrink-0 pt-2">
        ...
        {Icon && <Icon size={20} className="shrink-0 text-emerald-500" />}
      ...
      <div className="w-full px-2 sm:px-4 md:px-6 pr-1 pb-4 flex flex-col gap-6 items-center">
        {children}
      </div>
    </div>
  </motion.div>
