...
describe('ContactProfileModal', () => {
  ...
  it('calls onDelete when Delete confirmed', async () => {
    ...
    const deleteBtn = screen.getByRole('button', { name: /contacts\.deleteContact|Delete/ });
  ...
  it('does not call onDelete when Delete cancelled', async () => {
    ...
    const trashBtn = screen.getByRole('button', { name: /deleteContact/ });
  ...
  it('calls onBlock when Block confirmed', async () => {
    ...
    const banBtn = screen.getByRole('button', { name: /blockSpammer/ });
  ...
  it('applies dark theme styles', () => {
    ...
    const modal = screen.getByText('Test User').closest('[class*="modal-surface"]');
