  ...
  return (
    ...
    >
       <motion.div 
         ...
         className={`w-full max-w-sm p-6 shadow-2xl relative flex flex-col gap-5 ${isDark ? "bg-[var(--bg-tertiary)] border border-[var(--border-color)] text-[var(--text-primary)]" : "bg-white border border-[var(--border-color)] text-slate-800"}`}
       >
